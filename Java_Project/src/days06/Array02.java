...
public class Array02 {
	...
	public static void main(String[] args) {
		...
		int[] a1 = null;
		// null : 아무것도 없다는 뜻의 값
		String s1 = null; // Heap에 공간 확보가 되지 않은 상태
		String s2 = ""; // Heap에 공간이 확보되고 그 주소가 저장된 상태
		
		int[] b1; // null 값도 넣지 않은 상태. 초기화 되지 않은 상태
		System.out.println(a1);
		// System.out.println(b1); // 에러 - 초기화 되지 않은 변수의 사용은 레러
		// 변수에 null을 초기화 한 것과 아무것도 초기화 하지 않은 것은 다릅니다.
		a1 = new int[4];
		
		// 2. 배열 변수의 선언과 배열의 생성을 동시에 진행
		int[] a2 = new int[4];
		// new에 의해서 heap 메모리에 생성되는 모든 영역은 정수형 자료라면 0
		// 실수형 자료라면 0.0, String 자료라면 null 값으로 초기화 됩니다.
		...
		// 4. 배열 변수 a7, a8을 동시에 선언하는 코드
		int[] a7, a8;
		a7 = new int[3];
		a8 = new int[3];

		// 5. 배열변수와 일반변수를 동시에 선언이 가능합니다.
		int a9[], a10[], a11;
		// 배열변수(참조변수)는 변수 뒤에 대괄호를 표시합니다.
		a9 = new int[3];
		a10 = new int[3];
		a11 = 10;
	}
