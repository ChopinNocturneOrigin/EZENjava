...
// 멤버메서드를 제작하는 주된 목적은 private로 보호되는 멤버변수에 값을 저장하거나 얻어오거나
// 그 둘의 목적이 가장 큽니다.
// 따라서 특정 멤버메서드(값을 저장하거나 얻어오는 메서드)를 별도의 사유없이 필요한 만큼 만들고 시작하는
// 경우가 많습니다.
...
*/
	// 이클립스 메뉴 중에는 클래스의 private 멤버변수에 대한 getter, setter 메서드를 자동생성 해주는 메뉴가 있습니다.
