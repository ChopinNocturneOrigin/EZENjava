...
class Mymath {
	int a, b;
	static int c = 0;
	// 인스턴스 메서드에서 static 멤버변수에 접근이 가능합니다.
	...
	// 인스턴스 메서드에서는 인스턴스 멤버변수에 접근이 가능합니다.
	...
	// static 메서드에서는 인스턴스 변수에 접근이 불가능 합니다.
	// static 메서드에서는 static 변수에 접근이 가능 합니다.
...
public class Class27 {
	...
	public static void main(String[] args) {
		...
		Mymath mm = new Mymath(); // 객체 생성시 static 변수 c는 1증가
		...
		System.out.println("Mymath.substract(10, 30) -> " + Mymath.substract(10, 30));
	...
	// 다만 static으로 만들어진 main 메서드 안에서 호출해서 사용하려면 반드시 static으로
	// 생성해야 합니다.
