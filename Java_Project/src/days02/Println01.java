...
public class Println01 {
	...
	public static void main(String[] args) {
		...
		// Println은 \n이 없어도 모든 출력 후 줄바꿈을 한번 실행하여 줍니다.
		// System.out.println("\n"); <-- 두줄바꿈
		// printf와 같이 format 양식 글자(%d, %f 등)를 사용하지 못합니다.
		// 다만 printf 보다 출력이 간단 합니다.
		System.out.println();
